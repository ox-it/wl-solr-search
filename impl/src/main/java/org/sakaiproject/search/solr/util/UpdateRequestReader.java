...
public class UpdateRequestReader extends AbstractUpdateRequest {
    ...
    public UpdateRequestReader() {
        super(METHOD.POST, "/update");
    }

    public UpdateRequestReader(String url) {
        super(METHOD.POST, url);
    }

    public UpdateRequestReader add(final SolrInputDocument doc) {
        if (documents == null) {
    ...
    public UpdateRequestReader add(final Collection<SolrInputDocument> docs) {
        if (documents == null) {
